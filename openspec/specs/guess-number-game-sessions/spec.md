# guess-number-game-sessions Specification

## Purpose
TBD - created by syncing change add-guess-number-share-mode. Backend API for creating, sharing, and playing guess-the-number game sessions.
